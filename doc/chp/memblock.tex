...
size in bytes to allocate is passed through the \texttt{sz}
parameter. The value of \texttt{sz} is required to be greater than zero; this
condition is asserted in debug builds.
...
to check for the returned handle being non-\texttt{NULL} in the normal 
flow of code.

...
extern AG_NONULL ag_memblock      *ag_memblock_clone_align(const ag_memblock *, size_t);
...
extern AG_NONULL bool              ag_memblock_aligned(const ag_memblock *, size_t);
extern AG_NONULL void              ag_memblock_resize(ag_memblock **, size_t);
extern AG_NONULL void              ag_memblock_resize_align(ag_memblock **, size_t, size_t);

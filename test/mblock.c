...
AG_TEST_INIT(new_01, "ag_mblock_new() allocates memory on the heap for an"
             " int") {
...
AG_TEST_INIT(clone_01, "ag_mblock_clone() makes a deep copy of an int in the"
                " heap")
{
        int *i = ag_mblock_new(sizeof *i);
        *i = 555;

        int *j = ag_mblock_clone(i);
...
AG_TEST_INIT(clone_02, "ag_mblock_clone() makes a deep copy of a test structure"
                " in the heap")
{
        struct test *t = ag_mblock_new(sizeof *t);
        t->i = ag_mblock_new(sizeof *t->i);
        ...
        *t->j = -666;
        ...
        struct test *cp = ag_mblock_clone(t);
...
AG_TEST_INIT(clone_03, "ag_mblock_clone() returns a copy with another address")
{
        AG_AUTO(ag_mblock) *src = ag_mblock_new(sizeof(int));
        AG_AUTO(ag_mblock) *cp = ag_mblock_clone(src);
        AG_TEST_ASSERT (src != cp);
}
AG_TEST_EXIT();


AG_TEST_INIT(clone_04, "ag_mblock_clone() sets the reference count of the copy"
                " to 1")
{
        AG_AUTO(ag_mblock) *src = ag_mblock_new(sizeof(int));
        AG_AUTO(ag_mblock) *cp = ag_mblock_clone(src);
...
AG_TEST_INIT(clone_05, "ag_mblock_clone() does not change the reference count"
                       " of the source")
{
        AG_AUTO(ag_mblock) *src = ag_mblock_new(sizeof(int));
        AG_AUTO(ag_mblock) *cp = ag_mblock_clone(src);
...
AG_TEST_INIT(clone_06, "ag_mblock_clone() preserves the data size of the"
                       " source")
{
        AG_AUTO(ag_mblock) *src = ag_mblock_new(sizeof(int));
        AG_AUTO(ag_mblock) *cp = ag_mblock_clone(src);
...
AG_TEST_INIT(clone_07, 
             "ag_mblock_clone() maintains the total size of the source")
{
        AG_AUTO(ag_mblock) *src = ag_mblock_new(sizeof(int));
        AG_AUTO(ag_mblock) *cp = ag_mblock_clone(src);
...
AG_TEST_INIT(clone_align_01, 
             "ag_mblock_clone_align() makes a deep copy of an int")
{
        int *i = ag_mblock_new(sizeof *i);
        *i = 555;

        int *j = ag_mblock_clone_align(i, 8);
        AG_TEST_ASSERT (*j == 555);
...
AG_TEST_INIT(clone_align_02, 
             "ag_mblock_clone_align() makes a deep copy of a test structure")
{
        struct test *t = ag_mblock_new(sizeof *t);
        t->i = ag_mblock_new(sizeof *t->i);
        t->j = ag_mblock_new(sizeof *t->j);
        ...
        *t->j = -666;
        ...
        struct test *cp = ag_mblock_clone_align(t, 8);
        AG_TEST_ASSERT (*cp->i == *t->i && *cp->j == *t->j);
...
AG_TEST_INIT(clone_align_03, "ag_mblock_clone_align() returns a copy with another"
                " address")
{
        AG_AUTO(ag_mblock) *src = ag_mblock_new(sizeof(int));
        AG_AUTO(ag_mblock) *cp = ag_mblock_clone_align(src, 8);
        AG_TEST_ASSERT (src != cp);
}
AG_TEST_EXIT();


AG_TEST_INIT(clone_align_04, "ag_mblock_clone_align() sets the reference count of"
                " the copy to 1")
{
        AG_AUTO(ag_mblock) *src = ag_mblock_new(sizeof(int));
...
AG_TEST_INIT(clone_align_05, "ag_mblock_clone_align() does not change the"
...
AG_TEST_INIT(clone_align_06, "ag_mblock_clone_align() preserves the data size of"
                " the source")
{
        AG_AUTO(ag_mblock) *src = ag_mblock_new(sizeof(int));
        AG_AUTO(ag_mblock) *cp = ag_mblock_clone_align(src, 8);
...
AG_TEST_INIT(clone_align_07, "ag_mblock_clone_align() maintains the total size of"
                " the source")
{
        AG_AUTO(ag_mblock) *src = ag_mblock_new(sizeof(int));
        AG_AUTO(ag_mblock) *cp = ag_mblock_clone_align(src, 8);
...
AG_TEST_INIT(clone_align_08, "ag_mblock_clone_align() honours its alignment"
                " request")
{
        AG_AUTO(ag_mblock) *src = ag_mblock_new(sizeof(int));
        AG_AUTO(ag_mblock) *cp = ag_mblock_clone_align(src, 32);
                ...
                " copy of a struct with scalar fields")
{
        ...
        a->i = 555;
        a->j = -666;
        struct test2 *b = ag_mblock_clone(a);
...
{
        int *i = ag_mblock_new(sizeof *i);
        AG_AUTO(ag_string) *s = ag_mblock_str(i);

...
AG_METATEST_OBJECT_MANAGER(ag_http_response, HTML_200_EMPTY());
AG_METATEST_OBJECT_MANAGER(ag_http_response, JSON_201());
AG_METATEST_OBJECT_MANAGER(ag_http_response, TEXT_302_FILE());

AG_METATEST_OBJECT_CMP(ag_http_response, HTML_200_EMPTY(), JSON_201());
AG_METATEST_OBJECT_CMP(ag_http_response, HTML_200_EMPTY(), TEXT_302_FILE());
AG_METATEST_OBJECT_CMP(ag_http_response, TEXT_302_FILE(), JSON_201());

AG_METATEST_OBJECT_LT(ag_http_response, HTML_200_EMPTY(), JSON_201());
AG_METATEST_OBJECT_LT(ag_http_response, HTML_200_EMPTY(), TEXT_302_FILE());
AG_METATEST_OBJECT_LT(ag_http_response, TEXT_302_FILE(), JSON_201());

AG_METATEST_OBJECT_EQ(ag_http_response, HTML_200_EMPTY(), JSON_201());
AG_METATEST_OBJECT_EQ(ag_http_response, HTML_200_EMPTY(), TEXT_302_FILE());
AG_METATEST_OBJECT_EQ(ag_http_response, TEXT_302_FILE(), JSON_201());

AG_METATEST_OBJECT_GT(ag_http_response, HTML_200_EMPTY(), JSON_201());
AG_METATEST_OBJECT_GT(ag_http_response, HTML_200_EMPTY(), TEXT_302_FILE());
AG_METATEST_OBJECT_GT(ag_http_response, TEXT_302_FILE(), JSON_201());
